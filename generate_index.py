...
with open('consecutive-days/index.html','w') as f:
    f.write('<!DOCTYPE html><html><head><title>Consecutive days at the studio</title><link rel="stylesheet" href="css/style.css"></head><body id="dcontain"><h1 id="page-title">consecutive days at the studio</h1><div class="flexbox" id="fbox">')
